    ...
    <section class="painel-container white-background shadow">
        <form id="completeForm" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
            ...
            <div id="formPart1" class="form-part visible painel-area">
                ...
                <br>
                <button type="button" class="button-secondary button button-next shadow"
                    onclick="showFormPart()">Próximo</button>
            </div>
                ...
                <div class="grid-container">
                    ...
                    <div class="grid-item2">
                        ...
                        <input type="text" class="form-control" name="especializacao"
                            placeholder="Digite sua especialização" required autocomplete="on"></input>
                    </div>
                    <div class="grid-item">
                        <label for="sobre"></label>Sobre<br>
                        <input type="text" class="form-control" name="sobre" placeholder="Digite sobre você" required
                            autocomplete="on"></input>
                    </div>
                    <div class="grid-item2">
            ...
            <div id="camposContratante" class="painel-area form-part" style="display: none;">
                ...
                <div class="grid-container">
                    ...
                    <div class="grid-item2">
                        <label for="email"></label>Email <br>
                        <input type="email" class="form-control" name="email_cont" placeholder="Digite seu email"
                            required autocomplete="on"></input>
                    </div>
                    <div class="grid-item">
                        <label for="imagem"></label>Imagem <br>
                    ...
                    <div class="grid-item2">
                        <label for="sobre"></label>Sobre<br>
                        <input type="text" class="form-control" name="sobre_cont" placeholder="digite sobre você"
                            required autocomplete="on"></input>
                    </div>
                    <div class="grid-item">
                        <label for="cep"></label>CEP <br>
                        <input type="text" class="form-control" name="cep_cont" placeholder="Digite seu CEP" required
                            autocomplete="on"></input>
                    </div>
                    <div class="grid-item2">
                        <label for="telefone"></label>Telefone <br>
                        <input type="text" class="form-control" name="telefone_cont" placeholder="Digite seu telefone"
                            required autocomplete="on"></input>
                    </div>
                    <div class="grid-item">
                        <label for="login"></label>Login <br>
                ...
                <?php if (!empty($erro)): ?>
                    <p class="error-message text-center">
                        <?php echo html_entity_decode($erro); ?>
                    </p>
                <?php endif; ?>
            </div>
            ...
            <button type="button" id="return" class="button-return button-secondary button invisible"
                onclick="returnPart()">Voltar</button>
            <button type="button" onclick="submitForm()" id="cadastrar"
                class="button button-register shadow invisible"><a href="#">Cadastrar</a></button>
        </form>
    </section>
</section>
